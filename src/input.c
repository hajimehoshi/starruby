...
strb_InitializeSdlInput()
{
  ...
  SDLKey sdlKeys[] = {
    ...
    SDLK_CAPSLOCK, SDLK_CLEAR, SDLK_RIGHTBRACKET,
    ...
    SDLK_QUESTION, SDLK_QUOTE,
    SDLK_RCTRL, SDLK_RIGHT, SDLK_RALT, SDLK_RSHIFT,
    SDLK_SCROLLOCK, SDLK_SEMICOLON, SDLK_COMMA, SDLK_SLASH, SDLK_SPACE, SDLK_KP_MINUS,
    SDLK_TAB,
    SDLK_UP,
    -1,
  };
